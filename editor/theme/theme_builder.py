...
def build_custom_colors():
    ...
    return {
        ...
        'primary>defaultButton.activeBackground': theme['foreground_active'],
        'primary>defaultButton.hoverBackground': theme['foreground_active'],
        ...
        'foreground>progressBar.disabledBackground': theme['foreground_disabled'],
        'primary>progressBar.background': theme['foreground'],
        'scrollbar.background': theme['background'],
        'scrollbarSlider.activeBackground': theme['foreground_active'],
        'scrollbarSlider.background': theme['foreground'],
        'scrollbarSlider.disabledBackground': theme['foreground_disabled'],
        'scrollbarSlider.hoverBackground': theme['foreground_active'],
        'foreground>slider.disabledBackground': theme['foreground_disabled'],
        'foreground>sliderTrack.inactiveBackground': theme['foreground_disabled'],
        'primary>sliderHandle.activeBackground': theme['foreground_active'],
